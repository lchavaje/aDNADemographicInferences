...
@author: Liliana
"""
#Input data for Ms_param_test.py. Both files must be in the same directory.
...
modern_samples = [1, 2] # Populations in order 0, 1, ...
ancient_samples=1 #Ancient samples is assigned to population 0
time=1
